...
export default function Index() {
    ...
    const columns = [
        ...
        { accessorKey: 'parent_id', header: 'Parent Desk', sortable: true, searchable: true },
    ...
    const handleOpenAdd = () => {
        setForm({ id: undefined, name: '', parent_id: '', description: '' });
        setIsEdit(false);
        setOpen(true);
        setFormErrors({});
    };
    ...
    const handleEdit = (row: any) => {
        setForm({ id: row.id, name: row.name, parent_id: row.parent_id || '', description: row.description });
        setIsEdit(true);
        setOpen(true);
        setFormErrors({});
    };
